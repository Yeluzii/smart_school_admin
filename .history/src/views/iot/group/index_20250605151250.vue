<template>
	<el-card class="layout-query">
		<el-form ref="queryRef" :inline="true" :model="state.queryForm" @keyup.enter="getDataList()">
			...
			<el-form-item prop="tenantId">
				<el-input v-model="state.queryForm.tenantId" placeholder=""></el-input>
			</el-form-item>
	...
	<el-card>
		<el-space>
			<el-space>
				<el-button icon="Plus" type="primary" v-auth="'iot:group:insert'" @click="addOrUpdateHandle()">新增</el-button>
			</el-space>
			<el-space>
		...
		<el-table v-loading="state.dataListLoading" :data="state.dataList" border class="layout-table" show-overflow-tooltip
			...
			<el-table-column label="操作" fixed="right" header-align="center" align="center" width="150">
				<template #default="scope">
					<el-button type="primary" v-auth="'iot:device:update'" link
						@click="addOrUpdateHandle(scope.row.id)">修改</el-button>
					<el-button type="primary" v-auth="'iot:device:delete'" link
