<template>
  ...
  <el-card>
    ...
    <el-table v-loading="state.dataListLoading" :data="state.dataList" border class="layout-table" show-overflow-tooltip
      ...
      <el-table-column prop="updator" label="" header-align="center" align="center"></el-table-column>
      <el-table-column prop="orgId" label="" header-align="center" align="center"></el-table-column>
...
import { useGroupDeviceApi, useGroupDeviceSubmitApi } from '@/api/iot/group'
const emit = defineEmits(['refreshDataList'])
const visible = defineModel<boolean>('visible')
const state: IHooksOptions = reactive({
  dataListUrl: 'new/iot/group/device/page',
...
const getGroupDevice = (id: number) => {
  useGroupDeviceApi(id)
}
const queryRef = ref()
