<!-- <template>
	<el-dialog v-model="visible" :title="!dataForm.id ? '新增' : '修改'" :close-on-click-modal="false" draggable>
		<el-form ref="dataFormRef" :model="dataForm" :rules="dataRules" :label-width="100">
			...
			<el-form-item label="0不轮播 1轮播" prop="banner">
				<el-input v-model="dataForm.banner" placeholder="0不轮播 1轮播"></el-input>
			</el-form-item>
			<el-form-item label="0未发布 1已发布" prop="status">
				<el-input v-model="dataForm.status" placeholder="0未发布 1已发布"></el-input>
			</el-form-item>
			<el-form-item label="0不置顶 1置顶" prop="istop">
				<el-input v-model="dataForm.istop" placeholder="0不置顶 1置顶"></el-input>
			</el-form-item>
			<el-form-item label="作者" prop="author">
				<el-input v-model="dataForm.author" placeholder="作者"></el-input>
			</el-form-item>
			<el-form-item label="0公告 1校园信息" prop="type">
				<el-input v-model="dataForm.type" placeholder="0公告 1校园信息"></el-input>
			</el-form-item>
