<template>
	...
	<el-card>
		...
		>
			...
			<el-table-column prop="packageName" label="套餐名称" header-align="center" align="center"></el-table-column>
...
<script setup lang="ts" name="TenantPackageIndex">
...
const state: IHooksOptions = reactive({
	dataListUrl: 'new/business/package/page',
	deleteUrl: 'new/business/package',
	queryForm: {}
})
