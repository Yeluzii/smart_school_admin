<template>
	...
	<el-card>
		...
		>
			...
			<el-table-column label="操作" fixed="right" header-align="center" align="center" width="200">
				<template #default="scope">
					...
					<el-button type="primary" v-auth="'business:tenant:update'" link @click="updatePasswordHandle(scope.row.id)">密码</el-button>
		...
		<update-password v-if="updatePasswordVisible" ref="updatePasswordRef" v-model:visible="updatePasswordVisible"></update-password>
	</el-card>
</template>
...
const updatePasswordHandle = (id?: number) => {
	...
	nextTick(() => updatePasswordRef.value.init(id))
}
